...
static const DebugField ENVI_DEBUG_FIELDS[] = {
    ...
    {"plantWoodCStorageDelta", DEBUG_FIELD_DOUBLE, &envi.plantWoodCStorageDelta}};
...
static void outputDebugHeaders(DebugOutputFiles *debugOutputFiles) {
...
static void outputDebugState(DebugOutputFiles *debugOutputFiles, int year,
                             int day, double time) {
  if (debugOutputFiles == NULL) {
    return;
  }
