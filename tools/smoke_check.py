...
def check_results(smoke_dir: str, verbose: bool, base: bool):
  ...
  if has_header:
    ...
    cols = 'year day time plantWoodC plantLeafC woodCreation soil coarseRootC fineRootC litter soilWater soilWetnessFrac snow npp nee cumNEE gpp rAboveground rSoil rRoot ra rh rtot evapotranspiration fluxestranspiration minN soilOrgN litterN n2o nLeaching nFixation nUptake ch4 nppStorage bcdeltaC bcdeltaN bcdeltaW'
    cols = cols.split(' ')
