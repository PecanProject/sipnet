...
def check_results(smoke_dir: str, verbose: bool, base: bool):
  ...
  if has_header:
    ...
    cols = 'year day time plantWoodC plantLeafC woodCreation soil microbeC coarseRootC fineRootC litter soilWater soilWetnessFrac snow npp nee cumNEE gpp rAboveground rSoil rRoot ra rh rtot evapotranspiration fluxestranspiration minN soilOrgN litterOrgN n2oFlux nLeachFlux woodCStorageDelta bcdeltaC bcdeltaN'
    cols = cols.split(' ')
