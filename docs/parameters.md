...
| $f_{\text{fine root, exudation}}$ | fineRootExudation     | Fraction of $GPP$ from fine roots exuded to soil[^exudates]     | unitless | Documented in model structure; not currently a runtime param |
| $f_{\text{coarse root, exudation}}$ | coarseRootExudation   | Fraction of $GPP$ from coarse roots exuded to soil[^exudates]   | unitless | Documented in model structure; not currently a runtime param |
...
| $k_{\text{SOM,drain}}$  |                 | Soil organic matter drainage scaling parameter                                                                         | unitless                                                 | Documented in model structure / design notes; not currently a runtime param                                                                   |
