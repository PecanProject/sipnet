...
| ${\text{CH}_4}_{\text{soil},0}$   |                | Initial methane concentration in the soil                                | $\text{g C} \cdot \text{m}^{-2}$                                    |                                                                                          |
| ${\text{N}_2\text{O}}_{\text{soil},0}$ |                | Initial nitrous oxide concentration in the soil                          | $\text{g N} \cdot \text{m}^{-2}$                                    |                                                                                          |
