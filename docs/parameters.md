...
| 6   | $f_{\text{WHC},0}$        | soilWFracInit   | Initial soil water fraction                                                                          | unitless                                             | May exceed 1.0 when modeling flooded conditions; $W_{\text{soil},0} = f_{\text{WHC},0} \cdot W_{\text{WHC}}$                                                                |
...
| 50  |                          | rSoilConst1     |                                                                                                                        |                                                 | soil resistance = $e^{(rSoilConst1 - rSoilConst2 \cdot f_{\text{WHC}})}$                                                     |
| 51  |                          | rSoilConst2     |                                                                                                                        |                                                 | soil resistance = $e^{(rSoilConst1 - rSoilConst2 \cdot f_{\text{WHC}})}$                                                     |
