...
|   | $C_{\text{wood,storage}}$  | N/A             | Wood carbon storage pool (delta) (initialized to zero)                   | $\text{g C} \cdot \text{m}^{-2} \text{ ground area}$ | Tracks lag between NPP input and allocation output due to 5-day averaging; initialized to 0; can be negative. Total wood C = $C_{\text{wood}} + C_{\text{wood,storage}}$ |
...
|   | $N_{\text{org, litter},0}$ | litterOrgNInit  | Initial litter organic nitrogen content                                  | g N m$^{-2}$                                         |                                                                                                                                                                          |
|   | $N_{\text{org, soil},0}$   | soilOrgNInit    | Initial soil organic nitrogen content                                    | g N m$^{-2}$                                         |                                                                                                                                                                          |
|   | $N_{\text{min, soil},0}$   | minNInit        | Initial soil mineral nitrogen content                                    | g N m$^{-2}$                                         |                                                                                                                                                                          |
...
|     | $f_a$                    | fAnoxia            | soil wetness fraction at which O2 diffusion begins to limit aerobic respiration                                        |                                                 |                                                                                                                                                |
|     | $\eta$                   | anaerobicDecomRate | relative anaerobic decomposition rate, in (0,1]                                                                        |                                                 |                                                                                                                                                |
|     | $p$                      | anaerobicTransExp  | Methane anoxia sensitivity, controls sharpness of anaerobic transition; dimensionless, greater than 1                  |                                                 |                                                                                                                                                |
