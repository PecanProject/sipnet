...
- Leaf Carbon by the amount given as `leafC` (g C/m²)
- Wood Carbon by the amount given as `woodC` (g C/m²)
- Fine Root Carbon by the amount given as `fineRootC` (g C/m²)
- Coarse Root Carbon by the amount given as `coarseRootC` (g C/m²)
