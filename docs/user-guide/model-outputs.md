...
2023  200  harv     eventSoilC=1.40,eventLitterC=5.06,eventLeafC=-5.93,eventWoodC=-4.75,eventFineRootC=-3.73,eventCoarseRootC=-3.89,eventSoilOrgN=0.00,eventLitterN=0.00,eventOutputC=10.05,eventOutputN=0.00
2024   65  plant    eventLeafC=3.00,eventWoodC=4.00,eventFineRootC=5.00,eventCoarseRootC=6.00,eventInputC=18.00,eventInputN=0.00
2024   70  irrig    eventSoilWater=2.50,eventEvap=2.50
2024  200  harv     eventSoilC=1.40,eventLitterC=5.06,eventLeafC=-5.93,eventWoodC=-4.75,eventFineRootC=-3.73,eventCoarseRootC=-3.89,eventSoilOrgN=0.00,eventLitterN=0.00,eventOutputC=10.05,eventOutputN=0.00
```
