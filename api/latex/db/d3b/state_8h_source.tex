...
\DoxyCodeLine{00350\ }
\DoxyCodeLine{00351\ \ \ \textcolor{comment}{//\ OBSOLETE\ PARAMS}}
\DoxyCodeLine{00352\ \ \ \textcolor{comment}{//\ To\ be\ removed}}
\DoxyCodeLine{00353\ \ \ \textcolor{keywordtype}{double}\ baseSoilRespCold;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00354\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ soil\ respiration\ at\ 0\ degrees\ C\ and\ max\ soil}}
\DoxyCodeLine{00355\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ moisture\ when\ tsoil\ <\ coldSoilThreshold}}
\DoxyCodeLine{00356\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ (g\ C\ respired\ *\ g\string^-\/1\ soil\ C\ day\string^-\/1)}}
\DoxyCodeLine{00357\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ NOTE:\ read\ in\ as\ per-\/year\ rate!}}
\DoxyCodeLine{00358\ \ \ \textcolor{keywordtype}{double}\ soilRespQ10Cold;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00359\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ scalar\ determining\ effect\ of\ temp\ on\ soil\ resp.}}
\DoxyCodeLine{00360\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ when\ tsoil\ <\ coldSoilThreshold}}
\DoxyCodeLine{00361\ }
\DoxyCodeLine{00362\ \ \ \textcolor{keywordtype}{double}\ coldSoilThreshold;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00363\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ temp.\ at\ which\ use\ baseSoilRespCold\ and}}
\DoxyCodeLine{00364\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ soilRespQ10Cold\ (if\ SEASONAL\_R\_SOIL\ true)}}
\DoxyCodeLine{00365\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ (degrees\ C)}}
\DoxyCodeLine{00366\ \ \ \textcolor{keywordtype}{double}\ litWaterDrainRate;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00367\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ rate\ at\ which\ litter\ water\ drains\ into\ lower}}
\DoxyCodeLine{00368\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ layer\ when\ litter\ layer\ fully\ moisture-\/saturated}}
\DoxyCodeLine{00369\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ (cm\ water/day)}}
\DoxyCodeLine{00370\ \ \ \textcolor{keywordtype}{double}\ E0;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ E0\ in\ Lloyd-\/Taylor\ soil\ respiration\ function}}
\DoxyCodeLine{00371\ \ \ \textcolor{keywordtype}{double}\ T0;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ T0\ in\ Lloyd-\/Taylor\ soil\ respiration\ function}}
\DoxyCodeLine{00372\ \ \ \textcolor{keywordtype}{double}\ m\_ballBerry;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ slope\ for\ the\ Ball\ Berry\ relationship}}
\DoxyCodeLine{00373\ \ \ \textcolor{keywordtype}{double}\ totNitrogen;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ Percentage\ nitrogen\ in\ soil}}
\DoxyCodeLine{00374\ \ \ \textcolor{keywordtype}{double}\ microbeNC;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ mg\ N\ /\ mg\ C\ -\/\ microbe\ N:C\ ratio}}
\DoxyCodeLine{00375\ \ \ \textcolor{keywordtype}{double}\ qualityLeaf;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ value\ for\ leaf\ litter\ quality}}
\DoxyCodeLine{00376\ \ \ \textcolor{keywordtype}{double}\ qualityWood;\ \ \textcolor{comment}{//\ OBSOLETE\ PARAM\ \ value\ for\ wood\ litter\ quality}}
\DoxyCodeLine{00377\ }
\DoxyCodeLine{00378\ \ \ \textcolor{comment}{//\ initial\ litter\ water\ as\ fraction\ of\ litterWHC\ (unitless)}}
\DoxyCodeLine{00379\ \ \ \textcolor{comment}{//\ ::\ equivalent\ to\ W\_S,0\ in\ [2]}}
\DoxyCodeLine{00380\ \ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00381\ \ \ \textcolor{keywordtype}{double}\ litterWFracInit;}
\DoxyCodeLine{00382\ \ \ \textcolor{comment}{//\ litter\ (evaporative\ layer)\ water\ holding\ capacity\ (cm)}}
\DoxyCodeLine{00383\ \ \ \textcolor{comment}{//\ ::\ W\_S,c\ in\ [2]}}
\DoxyCodeLine{00384\ \ \ \textcolor{comment}{//\ OBSOLETE\ PARAM}}
\DoxyCodeLine{00385\ \ \ \textcolor{keywordtype}{double}\ litterWHC;}
\DoxyCodeLine{00386\ }
\DoxyCodeLine{00387\ \}\ Params;}
\DoxyCodeLine{00388\ }
\DoxyCodeLine{00389\ \textcolor{preprocessor}{\#define\ NUM\_PARAMS\ (sizeof(Params)\ /\ sizeof(double))}}
\DoxyCodeLine{00390\ }
\DoxyCodeLine{00391\ \textcolor{comment}{//\ the\ state\ of\ the\ environment}}
\DoxyCodeLine{00392\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }Environment\ \{}
\DoxyCodeLine{00393\ \ \ \textcolor{comment}{//\ From\ [1]\ Braswell\ et\ al.\ 2005}}
\DoxyCodeLine{00394\ \ \ \textcolor{keywordtype}{double}\ plantWoodC;\ \ \textcolor{comment}{//\ carbon\ in\ plant\ wood\ (above-\/ground\ +\ roots)\ (g\ C\ *\ m\string^-\/2}}
\DoxyCodeLine{00395\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ ground\ area)}}
\DoxyCodeLine{00396\ \ \ \textcolor{keywordtype}{double}\ plantLeafC;\ \ \textcolor{comment}{//\ carbon\ in\ leaves\ (g\ C\ *\ m\string^-\/2\ ground\ area)}}
\DoxyCodeLine{00397\ \ \ \textcolor{keywordtype}{double}\ soil;\ \ \textcolor{comment}{//\ carbon\ in\ soil\ (g\ C\ *\ m\string^-\/2\ ground\ area)}}
\DoxyCodeLine{00398\ \ \ \textcolor{keywordtype}{double}\ soilWater;\ \ \textcolor{comment}{//\ plant\ available\ soil\ water\ (cm)}}
\DoxyCodeLine{00399\ }
\DoxyCodeLine{00400\ \ \ \textcolor{comment}{//\ From\ [2]\ Sacks\ et\ al.\ 2006}}
\DoxyCodeLine{00401\ \ \ \textcolor{comment}{//\ carbon\ in\ litter\ (g\ C\ *\ m\string^-\/2\ ground\ area)}}
\DoxyCodeLine{00402\ \ \ \textcolor{keywordtype}{double}\ litter;}
\DoxyCodeLine{00403\ \ \ \textcolor{comment}{//\ snow\ pack\ (cm\ water\ equiv.)}}
\DoxyCodeLine{00404\ \ \ \textcolor{keywordtype}{double}\ snow;}
\DoxyCodeLine{00405\ }
\DoxyCodeLine{00406\ \ \ \textcolor{comment}{//\ From\ [3]\ Zobitz\ et\ al.\ (2008)}}
\DoxyCodeLine{00407\ \ \ \textcolor{keywordtype}{double}\ coarseRootC;}
\DoxyCodeLine{00408\ \ \ \textcolor{keywordtype}{double}\ fineRootC;}
\DoxyCodeLine{00409\ }
\DoxyCodeLine{00410\ \ \ \textcolor{comment}{//\ From\ [4]\ Zobitz\ (draft)}}
\DoxyCodeLine{00411\ \ \ \textcolor{keywordtype}{double}\ microbeC;\ \ \textcolor{comment}{//\ carbon\ in\ microbes\ (g\ C\ m-\/2\ ground\ area)}}
\DoxyCodeLine{00412\ \}\ Envi;}
\DoxyCodeLine{00413\ }
...
\DoxyCodeLine{00517\ \ \ \textcolor{comment}{//\ Fluxes\ from\ other\ sources,\ provenance\ TBD}}
\DoxyCodeLine{00518\ \ \ \textcolor{comment}{//}}
\DoxyCodeLine{00519\ }
\DoxyCodeLine{00520\ \ \ \textcolor{comment}{//\ leaf\ creation\ term\ as\ determined\ by\ growing\ season\ boundaries\ (as\ in\ [1])}}
\DoxyCodeLine{00521\ \ \ \textcolor{comment}{//\ and\ NPP\ (as\ in\ [2])}}
\DoxyCodeLine{00522\ \ \ \textcolor{comment}{//\ C\ transferred\ from\ wood\ to\ leaves\ (g\ C\ *\ m\string^-\/2\ ground\ area\ *\ day\string^-\/1)}}
\DoxyCodeLine{00523\ \ \ \textcolor{keywordtype}{double}\ leafCreation;}
\DoxyCodeLine{00524\ \ \ \textcolor{comment}{//\ wood\ creation\ term,\ dependent\ on\ NPP\ similar\ to\ leaf\ creation,\ but}}
\DoxyCodeLine{00525\ \ \ \textcolor{comment}{//\ provenance\ TBD\ (g\ C\ *\ m\string^-\/2\ ground\ area\ *\ day\string^-\/1)}}
\DoxyCodeLine{00526\ \ \ \textcolor{keywordtype}{double}\ woodCreation;}
\DoxyCodeLine{00527\ }
\DoxyCodeLine{00528\ \}\ Fluxes;}
\DoxyCodeLine{00529\ }
\DoxyCodeLine{00530\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }TrackerVars\ \{\ \ \textcolor{comment}{//\ variables\ to\ track\ various\ things}}
\DoxyCodeLine{00531\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up\ in\ this\ time\ interval;\ GROSS\ photosynthesis}}
\DoxyCodeLine{00532\ \ \ \textcolor{keywordtype}{double}\ gpp;}
\DoxyCodeLine{00533\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ respired\ in\ this\ time\ interval}}
\DoxyCodeLine{00534\ \ \ \textcolor{keywordtype}{double}\ rtot;}
\DoxyCodeLine{00535\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ autotrophic\ resp.\ in\ this\ time\ interval}}
\DoxyCodeLine{00536\ \ \ \textcolor{keywordtype}{double}\ ra;}
\DoxyCodeLine{00537\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ heterotrophic\ resp.\ in\ this\ time\ interval}}
\DoxyCodeLine{00538\ \ \ \textcolor{keywordtype}{double}\ rh;}
\DoxyCodeLine{00539\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up\ in\ this\ time\ interval}}
\DoxyCodeLine{00540\ \ \ \textcolor{keywordtype}{double}\ npp;}
\DoxyCodeLine{00541\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ given\ off\ in\ this\ time\ interval}}
\DoxyCodeLine{00542\ \ \ \textcolor{keywordtype}{double}\ nee;}
\DoxyCodeLine{00543\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up,\ year\ to\ date:\ GROSS\ photosynthesis}}
\DoxyCodeLine{00544\ \ \ \textcolor{keywordtype}{double}\ yearlyGpp;}
\DoxyCodeLine{00545\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ respired,\ year\ to\ date}}
\DoxyCodeLine{00546\ \ \ \textcolor{keywordtype}{double}\ yearlyRtot;}
\DoxyCodeLine{00547\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ autotrophic\ resp.,\ year\ to\ date}}
\DoxyCodeLine{00548\ \ \ \textcolor{keywordtype}{double}\ yearlyRa;}
\DoxyCodeLine{00549\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ heterotrophic\ resp.,\ year\ to\ date}}
\DoxyCodeLine{00550\ \ \ \textcolor{keywordtype}{double}\ yearlyRh;}
\DoxyCodeLine{00551\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up,\ year\ to\ date}}
\DoxyCodeLine{00552\ \ \ \textcolor{keywordtype}{double}\ yearlyNpp;}
\DoxyCodeLine{00553\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ given\ off,\ year\ to\ date}}
\DoxyCodeLine{00554\ \ \ \textcolor{keywordtype}{double}\ yearlyNee;}
\DoxyCodeLine{00555\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up,\ to\ date:\ GROSS\ photosynthesis}}
\DoxyCodeLine{00556\ \ \ \textcolor{keywordtype}{double}\ totGpp;}
\DoxyCodeLine{00557\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ respired,\ to\ date}}
\DoxyCodeLine{00558\ \ \ \textcolor{keywordtype}{double}\ totRtot;}
\DoxyCodeLine{00559\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ autotrophic\ resp.,\ to\ date}}
\DoxyCodeLine{00560\ \ \ \textcolor{keywordtype}{double}\ totRa;}
\DoxyCodeLine{00561\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ heterotrophic\ resp.,\ to\ date}}
\DoxyCodeLine{00562\ \ \ \textcolor{keywordtype}{double}\ totRh;}
\DoxyCodeLine{00563\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ taken\ up,\ to\ date}}
\DoxyCodeLine{00564\ \ \ \textcolor{keywordtype}{double}\ totNpp;}
\DoxyCodeLine{00565\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ given\ off,\ to\ date}}
\DoxyCodeLine{00566\ \ \ \textcolor{keywordtype}{double}\ totNee;}
\DoxyCodeLine{00567\ \ \ \textcolor{comment}{//\ cm\ water\ evaporated/sublimated\ (sublimed???)\ or\ transpired\ in\ this\ time}}
\DoxyCodeLine{00568\ \ \ \textcolor{comment}{//\ step}}
\DoxyCodeLine{00569\ \ \ \textcolor{keywordtype}{double}\ evapotranspiration;}
\DoxyCodeLine{00570\ \ \ \textcolor{comment}{//\ mean\ fractional\ soil\ wetness\ (soilWater/soilWHC)\ over\ this\ time\ step}}
\DoxyCodeLine{00571\ \ \ \textcolor{comment}{//\ (linear\ mean:\ mean\ of\ wetness\ at\ start\ of\ time\ step\ and\ wetness\ at\ end\ of}}
\DoxyCodeLine{00572\ \ \ \textcolor{comment}{//\ time\ step)}}
\DoxyCodeLine{00573\ \ \ \textcolor{keywordtype}{double}\ soilWetnessFrac;}
\DoxyCodeLine{00574\ }
\DoxyCodeLine{00575\ \ \ \textcolor{comment}{//\ g\ C\ m-\/2\ of\ root\ respiration}}
\DoxyCodeLine{00576\ \ \ \textcolor{keywordtype}{double}\ rRoot;}
\DoxyCodeLine{00577\ \ \ \textcolor{comment}{//\ Soil\ respiration\ (microbes+root)}}
\DoxyCodeLine{00578\ \ \ \textcolor{keywordtype}{double}\ rSoil;}
\DoxyCodeLine{00579\ }
\DoxyCodeLine{00580\ \ \ \textcolor{comment}{//\ Wood\ and\ foliar\ respiration}}
\DoxyCodeLine{00581\ \ \ \textcolor{keywordtype}{double}\ rAboveground;}
\DoxyCodeLine{00582\ \ \ \textcolor{comment}{//\ g\ C\ *\ m\string^-\/2\ litterfall,\ year\ to\ date:\ SUM\ litter}}
\DoxyCodeLine{00583\ \ \ \textcolor{keywordtype}{double}\ yearlyLitter;}
\DoxyCodeLine{00584\ \}\ Trackers;}
\DoxyCodeLine{00585\ }
\DoxyCodeLine{00586\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }PhenologyTrackersStruct\ \{}
\DoxyCodeLine{00587\ \ \ \textcolor{comment}{//\ variables\ to\ track\ each\ year's\ phenological\ development.\ Only\ used\ in}}
\DoxyCodeLine{00588\ \ \ \textcolor{comment}{//\ leafFluxes\ function,\ but\ made\ global\ so\ can\ be\ initialized\ dynamically,}}
\DoxyCodeLine{00589\ \ \ \textcolor{comment}{//\ based\ on\ day\ of\ year\ of\ first\ climate\ record}}
\DoxyCodeLine{00590\ }
\DoxyCodeLine{00591\ \ \ \textcolor{comment}{//\ have\ we\ done\ leaf\ growth\ at\ start\ of\ growing\ season\ this\ year?\ (0\ =\ no,}}
\DoxyCodeLine{00592\ \ \ \textcolor{comment}{//\ 1\ =\ yes)}}
\DoxyCodeLine{00593\ \ \ \textcolor{keywordtype}{int}\ didLeafGrowth;}
\DoxyCodeLine{00594\ \ \ \textcolor{comment}{//\ have\ we\ done\ leaf\ fall\ at\ end\ of\ growing\ season\ this\ year?\ (0\ =\ no,}}
\DoxyCodeLine{00595\ \ \ \textcolor{comment}{//\ 1\ =\ yes)}}
\DoxyCodeLine{00596\ \ \ \textcolor{keywordtype}{int}\ didLeafFall;}
\DoxyCodeLine{00597\ \ \ \textcolor{comment}{//\ year\ of\ previous\ time\ step,\ for\ tracking\ when\ we\ hit\ a\ new\ calendar\ year}}
\DoxyCodeLine{00598\ \ \ \textcolor{keywordtype}{int}\ lastYear;}
\DoxyCodeLine{00599\ \}\ PhenologyTrackers;}
\DoxyCodeLine{00600\ }
\DoxyCodeLine{00601\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ SIPNET\_STATE\_H}}
