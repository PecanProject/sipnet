...
int main(int argc, char *argv[]) {
  ...
  char outFile[256];
  char paramFile[256], climFile[256], girdleFile[256];
  int runNum;
  ...
  strcpy(girdleFile, argv[optind]);
  strcat(girdleFile, ".girdle");
  
  numLocs = initModel(&spatialParams, &steps, paramFile, climFile, girdleFile);
